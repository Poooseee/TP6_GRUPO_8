...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:GridView ID="grdProductos" runat="server" AllowPaging="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowEditing="grdProductos_RowEditing" AutoGenerateColumns="False" OnRowCancelingEdit="grdProductos_RowCancelingEdit">
